...
void EventAction::BeginOfEventAction(const G4Event* evt)
{
 ...
 fEnergyExitTargetPrimary = fEnergyExitTargetSecondaryPositron = fEnergyExitTargetSecondaryElectron = fEnergyExitTargetSecondaryMuonPlus = fEnergyExitTargetSecondaryMuonMinus = fEnergyExitTargetCharged = fEnergyExitTargetChargedCut05GeV = fEnergyExitTargetChargedCut1GeV = fEnergyExitTargetIoni = fEnergyExitTargetPP1 = fEnergyExitTargetPP2 = fEnergyExitTargetIoniCut05GeV = fEnergyExitTargetPP1Cut05GeV = fEnergyExitTargetPP2Cut05GeV = fEnergyExitTargetIoniCut1GeV = fEnergyExitTargetPP1Cut1GeV = fEnergyExitTargetPP2Cut1GeV = fEnergyExitTargetBrems = fEnergyExitTargetNucl = 0.;
 fAnglePrimary = fAngleSecondaryPositron = fAngleSecondaryElectron = fAngleSecondaryMuonPlus = fAngleSecondaryMuonMinus = fAngleCharged = fAngleChargedCut05GeV = fAngleChargedCut1GeV = fAngleIoni = fAnglePP1 = fAnglePP2 = fAngleIoniCut05GeV = fAnglePP1Cut05GeV = fAnglePP2Cut05GeV = fAngleIoniCut1GeV = fAnglePP1Cut1GeV = fAnglePP2Cut1GeV = fAngleBrems = fAngleNucl = 0.;
fAnglee = 0.;

 fBoolPrim = fBoolSecPositron = fBoolSecElectron = fBoolSecMuonPlus = fBoolSecMuonMinus = fBoolCharged = fBoolChargedCut05GeV = fBoolChargedCut1GeV = fBooleIoni = fBoolePP1 = fBoolePP2 = fBooleIoniCut05GeV = fBoolePP1Cut05GeV = fBoolePP2Cut05GeV = fBooleIoniCut1GeV = fBoolePP1Cut1GeV = fBoolePP2Cut1GeV = fBoolBrems = fBoolNucl = 0;
 fNbTracks = fNbTracksCut05GeV = fNbTracksCut1GeV = 0;
 
 fePlusx = fePlusy = fePlusz = feMinusx = feMinusy = feMinusz = 0.;
...
void EventAction::EndOfEventAction(const G4Event* evt)
{
 ...
 if ((fBoolSecPositron == 1) && (fBoolSecElectron == 1))  {
    fAnglee = acos(fePlusx*feMinusx + fePlusy*feMinusy + fePlusz*feMinusz);
    analysisManager->FillH1(33, fAnglee);
 ...
 if (fBoolBrems == 1)  {
    analysisManager->FillH1(34, fEnergyExitTargetBrems);
    analysisManager->FillH1(36, fAngleBrems);
 }
 
 if (fBoolNucl == 1)  {
    analysisManager->FillH1(35, fEnergyExitTargetNucl);
    analysisManager->FillH1(37, fAngleNucl);
 }
 ...
 if ((fBoolPrim == 1) && (fBoolSecPositron == 1) && (fBoolSecElectron == 1))  {
    analysisManager->FillH2(11, fAngleSecondaryElectron, fAngleSecondaryPositron);
 }
